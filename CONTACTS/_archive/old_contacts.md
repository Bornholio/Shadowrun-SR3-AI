...
**Exception:** See Safe Contacts section below.
...
may still work there under new management, may have scattered, or may know
something about what happened to the building.

Approaching Taetzal-connected contacts carries the additional risk that
whoever now owns the building may be watching former staff.

---

## Safe Contacts — Depth Understanding

Two contacts in the network have the combination of skills, discretion, and
existing knowledge to understand what separating an old life from a new one
actually requires. These two can be approached with reduced risk — they have
seen enough to ask fewer dangerous questions.

---

### Morgan "Popsicle" Ulstar
**Type:** Fixer | **Rating:** 3 | **Location:** Denver
**Primary:** Pentarus *(orphaned)*
**Specialty:** IDs, certified credsticks, Denver safe houses

The best ID man in the network. Rating 3, Denver-based, Nexus-connected.
Popsicle understands that identity replacement is not paperwork — it is the
complete destruction and reconstruction of a person's paper existence.
...
**Popsicle ID Discovery Rule:**
As long as any of the 3PR are actively pursuing fake ID upgrades or
replacement credentials, there is a small monthly chance that Popsicle
encounters matching identity materials in his normal forgery work — discarded
SINs, orphaned corporate identities, genetic profile gaps that fit. This is
passive. He does not know he is looking for them. The GM rolls monthly
(suggested TN 8, 1 die — success means he has found something useful and
will offer it to active clients at standard rates).
...
Patchwork has seen enough unusual biology, post-SURGE presentation, and
delta-grade hardware to understand that the person in front of him is not
always the person on the SIN. He will not ask questions he does not need
answered. He will not volunteer information.

The Taetzal connection makes approach complicated — he may still work there
under new management, in which case the building is a risk. Finding him
outside Taetzal is preferable for a first contact.

---

## Contact Recovery Rules
...
This is an extraordinary social test — not a standard Etiquette roll.
The GM should require:
- A plausible explanation for how they survived and why they look different
- Evidence only the real person could provide (specific shared memory,
  knowledge of private details, recognition of something the contact never
  told anyone else)
- The contact's willingness to believe, which varies by personality
...
**The Dunkelzahn factor:**
Dunkelzahn was assassinated 08/09/57 — less than seven months before the family
...
If he recognizes them — and given proximity to Auburn, encounter is possible —
he will treat them with cold professional neutrality. He will not acknowledge
the prior relationship. He will not reach out. He will not risk drawing
attention to people who are supposed to be dead, because he understands
exactly what that kind of attention costs.

If the family approaches him as strangers and he works with them, he will
be professionally competent and nothing more. He may be fractionally more
generous than his rates suggest. He will never explain why.

*GM note: Blackstone knows more about the Auburn corridor than he will say.
His private facility's proximity to Route 167 is not coincidence.*

---

## Full Contact Roster

*Sorted by type. Primary handler noted. FoF = Friends of Friends (indirect
relationship — lower trust ceiling even if recovered).*
...
| Name | Rating | Location | Primary | Notes |
|---|---|---|---|---|
| Magnolia P Johnson | 1 | Denver/Seattle | Pentarus | Data broker — orphaned |
| Amélie Gagnon "Sleet" | 1 | Montreal | Pentarus | Story burying, leaks — orphaned |
...
Ehran-Minor's Bastard/Laésa (FoF), El Toro/Los Reyes, Granite Jaw/Blood Mountain Boys,
Matchstick/Halloweeners, Mother Skraacha/Skraacha, Old Man Rust/Rat's Nest,
Orlando R3/Triple Point, Razor Hank/Spikes, Red Eye/Sons of Sauron,
Roxie Red/Crimson Crush, Shark/Double Devils (FoF), Stalker/Night Hunters,
Switchblade Joe/Black Razors, Torque/Razor Boys, Viejo Lobo/Chulos.

**Gang Members (selected notable, Seattle):**
Bitrate R2/Razor Boys, Cinder R2/Halloweeners, Cinderblock R2/Sons of Sauron,
Crowbar R2/Komun'go, Pebble R2/Blood Mountain Boys, Pitbull R2/Spikes,
Tin Can R2/Rat's Nest, Vixen R2/Crimson Crush.
All others Rating 1. Full list available on request.
