...
Issued by Sle-cheep Watkins, Pinnacle Peak Park, Muckleshoot NAN.

Functions as:
- Basic tribal ID — Muckleshoot/NAN territory recognition
- Permits possession and transport of awakened animals to park facilities
- Awakened animal transport to Salish territory legal under this pass with prior contact to relevant tribal official
- Using outside park draws attention — flags NAN tribal connections to any observer running the document
- Valid in NAN/Salish-Shidhe jurisdiction; UCAS/Seattle: unusual but not illegal
