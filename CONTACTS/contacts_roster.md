...
## Family Assets *(non-contact relationships)*

**Dag** → family asset, not a contact
Awakened critter · 247kg · mustelid variant · ancient
*Status: Settled — Pinnacle Peak Park, Muckleshoot tribal land*
...
*S09: HMS second signatory name delivered. Theory about reset — holding. F&V Baptist commcode held.*
*S10: Watcher on his building confirmed pale architect placed it.*
...
Decker · signal intercept · Rating 1 · Etiquette Matrix
*S11: Flagged for cellular decryption analysis — Ghostline's 12-day intercept data, crackable component. Pending activation.*
...
*S04: Frame failed. Manual approach needed.*

**Room 6 Man** → codename: TBD
Professional · unknown affiliation · Rating 1 · burner commcode only
*S08: Thumbs up received re: RAVN warning. "When you're ready" — unanswered.*
...
Commcode: 9206-ΔMED-4471
*S08: "A little weird around here lately."*
*S11: Stolen livery case now active in LS system — she will see movement before end of shift Tuesday. Follow-up warranted.*

**Street Doc** *(name unknown)* → codename: TBD
Street doc · magical triage backup · Rating 1 · Etiquette Street
*S04: Reconnected. Standing offers active.*

**Tourniquet** *(street name)* → codename: TBD
Medical logistics fixer · Rating 1 · Etiquette Street · Kessler's diner
Walk-in only. Three HRT clients — third arrived 4 days before S08, GM controlled.
*Clinic placement confirmed — operator contact card held by Banshee.*
...
Hermetic contact · spell formulae · Rating 1 · Etiquette Street
...
*S04: Reconnected. Cash only.*

**Mechanic** *(Teodor Breckenridge)* → codename: TBD
...
Specialty: Emergency triage, trauma stabilization, 3 years Belltown sector observation
*S06: Treated Rat alongside Banshee. Debt incurred.*
*S10: Three victims on 3rd confirmed — Ghostline, Fen, unknown ork. Full picture shared with Banshee.*
*S11: Street shaman warned and extracted before session. Trauma kit left at Nährboden — DW internal case risk reduced. Participated in Fen extraction as medical support. Debt deepened significantly.*
*⚠️ Trauma kit serial flagged in pending DW internal investigation — kit now at Nährboden, not on Oswin. LS cross-referencing stolen livery equipment now. Risk reduced but not eliminated.*

**Marta** *(surname unknown)* → codename: TBD
SINless-adjacent · Belltown sector regular
*S06: Bag recovered, healed. F&V Baptist commcode held.*

**Rat** *(street name only)* → codename: TBD
Disassembler prospect · south end crew · ~17
*S06: Treated by Banshee. F&V Baptist commcode held.*

**Nährboden** → codename: TBD
Matrix den operator · Nährboden Haus, back alley off 3rd Street, Belltown
Gender: Female · Age: Mid-30s · Metatype: Human
`B4 Q4 S3 C4 I7 W5 | Init 11+1d6` · Computer 8, Electronics 7, Decking 6, Etiquette(Street) 5, Perception 7, Negotiation 5
Specialty: High-speed Matrix access, signal boost, no-SIN operations — den operator
...
Matrix security analyst · SINless · Nährboden Haus regular
Gender: Male · Age: Unknown · Metatype: Human
...
Gray market port work · SINless · Belltown sector
Gender: Female · Age: Unknown · Metatype: Elf
Specialty: Physical data courier, gray market matrix port work, street-level network
*S10: Flagged as RAVN victim — missing 3+ days, gray market DW pickup.*
*S11: Recovered from St. Peter Claver genetics research annex (Renraku-adjacent). Medical clearance by Oswin + Banshee Heal F6. Full research dossier transferred via Singer datajack. Partial Night One adjacent meta-genetic markers — unactivated. Settled at Redmond secondary location. F&V Baptist commcode held. Clean phone provided.*
*Note: Self-dressed IV port wound, pulled own IV, improvised chair leg weapon — was ready to leave from day one.*

**Street Shaman** *(name unknown)* → codename: TBD
Street shaman · recently expressed feathers · SINless · Belltown chiphead community
Gender: Unknown · Age: Unknown · Metatype: Unknown
Specialty: Informal magical support for chiphead recovery community
*S11: Identified as priority three on Tamanous active acquisitions list. Warned and extracted by Oswin before session close. Safe. Does not know the full scope of the threat.*
*Note: Uninitiiated. Recent SURGE expression. Belltown community asset.*
...
Looking for the seven. Not a threat. Singer has passive receive on her channel. Auto-squelch on Reyes installed.
*S11: Three tips received — SoDo, garage on 3rd, St. Peter Claver. CSS-7 case number embedded. SANS host keyed via commcode + doorstop frame. Running split from Raus, managing GT handler independently. On site at St. Peter Claver by session end. Very active.*

**Detective Dekker Raus** — LS Special Investigations, PR 3
Okonkwo's partner. Defers completely. Running visible/reportable pattern while Okonkwo moves independently.
...
**Unknown Commcode** → active thread
Left by two private operatives asking about Carpenter. Mechanic cover approach — radio install pending, Mechanic warns first.

**Pier Man** → active thread
Icon and contact card held by Carpenter. Callum Shire is working elf identity. Can read proto-Sperethiel. Waiting.

**Unknown Ork Male** → active thread
~22, minimal chrome, hit Futureman Project host. Recovering at 3rd Street shelter. ICE cleared by Banshee S10. Futureman host address source. Directed to visit Nährboden when able.

**Tamanous Collector** → active thread
Delivered to fixer's alley, alive, contained, wrapped. Commlink disabled. Fixer has him and the case. What happens next is the fixer's call.

---

## Park Passes — All Four (Keystone, Crowbar, Meridian, Kluger)

Issued by Sle-cheep Watkins, Pinnacle Peak Park, Muckleshoot NAN. Functions as basic tribal ID and awakened animal transport permit.
