...
Voice Call column below represents worst case signal quality (storm or extreme solar activity).
...
Requires knowing the commcode of the phone, users may have multiple commcodes per device (vs Simcard)
