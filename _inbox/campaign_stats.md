...
**Hair:** Stark white | **Eyes:** Emerald green, diamond-shaped pupils
**Fur:** White, fine, close
**Tradition:** Hermetic (sorcery) / Lover Mentor (conjuring)
- Sorcery side: library, no masking on powerful spells, hermetic framework
...
**Type:** Awakened critter — mustelid family, undocumented variant
**Mass:** 247kg | **Appearance:** White/silver fur, wolverine-shaped, head to Keystone's chest
**Status:** Settled — Pinnacle Peak Park, Muckleshoot tribal land
**Den:** Under large rock formation near the peak
**Range:** Whole mountain

**Key facts:**
- Chosen hibernation — went to sleep on purpose, waiting for Keystone specifically
- Intellect confirmed — genuine, considered, patient
- Predates the Awakening magically — core aura older than 2011
- Called by Keystone ~40 years ago, Seattle area, without conscious intent
- Astral Chameleon initiate traces on outer aura — left deliberately by high-grade initiate
- Smells like the family — "old blood" resonance
- Named by Keystone: *"You were very pleased with yourself."*
- Hearth Spirit of the squatter building had prior relationship with Dag
- Muckleshoot keep magical watch on boundary — they know what Dag is, have for some time
- Contact method: Keystone physical presence on mountain. Dag initiates independently on own timeline.

**Greater Wolverine baseline (P/NA) — Dag significantly exceeds:**
`B7 Q4×5 S4 C— I2/4 W2 E6 R5* | Init: 5+2d6`
Powers: EPA(Qui), ERct, ESen(Smell+) | Weakness: ReducedSenses(Vision)
*Dag's actual stats unknown — mass ×3, echolocation at idle, chosen intellect, ancient magical resonance. TC database: no match.*

---

## Flurry — Blackberry Cat
...
**Powers:** Accident(LOS), Adaptive Coloration, Blindness(LOS), Compulsion(LOS), Darkness, Desire Reflection(LOS), Enhanced Movement, Enhanced Reactions([E]d6 turns, 1d6/day), Enhanced Senses(Low-Light Vision), Hypnotic Howl/Miaow(Zone×2), Illusion(LOS)

**Weakness — Catnip:** Scent: WIL TN 6, zero successes = moves toward source. Physical contact: +2TN all tests for 6d6 turns.

**Dual natured:** Exists simultaneously physical and astral. Always astrally perceiving. Has observed every spirit, projection, and aura since McHugh's from inside the pack.

**Notes:** Run ×5. Perception 8. Enhanced Reactions: up to 1d6/day adds 6d6 initiative — peak 6+9d6. Faster than any family member at peak. Domesticated as a blackberry cat can be. Spring form carrier with food kit — this was planned.
...
| Str max | 7 | 7 | 9 | 9 | 9 | 7 | 7 |
| Cha max | 9 | 9 | 10 | 11 | 10 | 9 | 9 |
| Int max | 7 | 7 | 9 | 8 | 8 | 7 | 7 |
| Wil max | 8 | 8 | 9 | 9 | 9 | 7 | 7 |
...
| Str ceil | 10 | 10 | 13 | 13 | 13 | 10 | 10 |
| Cha ceil | 13 | 13 | 15 | 16 | 15 | 13 | 13 |
| Int ceil | 10 | 10 | 13 | 12 | 12 | 10 | 10 |
| Wil ceil | 12 | 12 | 13 | 13 | 13 | 10 | 10 |

### Actual Stats — Base (Situational Augmented)[Cyber]

*CHA notation: base / pheromones within 30m / pheromones + cosmetic surgery close*
...
| Strength | 8 | 8 | 11(14) | 9(13) | 9(13) | 6 | 6 |
| Charisma | 9 | 9 | 11/15[16] | 16/20[21] | 11/15[16] | 8 | 8 |
| Intelligence | 8 | 8 | 11(13) | 11(13) | 11(13) | 6 | 6 |
| Willpower | 8 | 8 | 11 | 14 | 11 | 6 | 6 |
| Reaction | 14 | 14 | 24 | 24 | 26 | 12 | 12 |
| Initiative | 14+1d6 | 14+1d6 | 24+3d6 | 24+3d6 | 26+3d6 | 12+1d6 | 12+1d6 |
...
| Drain WIL | 11 | 14 | 11 |
| Astral INT | 11 | 11 | 11 |
| Spellcast INT | 11 | 11 | 11 |
| Spell Pool | 12 | 12 | 11 |
| Hacking Pool (Singer) | 12 | — | — |

### Singer — Decking Initiative Reference
...
| Carpenter | 8 | Masking, Channeling, Invoking, Shielding, Sensing, Reflecting |
| Keystone | None | — |
| Meridian | None | — |
| Crowbar | None | — |
| Kluger | None | — |
...
| Vehicle Empathy | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ |
| Spirit Empathy (Water) | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ |
| Exceptional Attribute (All) | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ |
| Aptitude (Polearms) | ✓ | ✓ | — | — | — | ✓ | ✓ |
| College Education | — | — | ✓ | ✓ | — | — | — |
| Tech School Education | — | — | ✓ | — | — | — | — |
| Natural Aptitude | — | — | — | — | ✓ | — | — |
| Aptitude (multiple — see sheets) | — | — | ✓ | ✓ | ✓ | — | — |
| +1 Intelligence | — | — | ✓ | — | — | — | — |
| +1 Charisma | — | — | — | ✓ | — | — | — |
| +1 Quickness | — | — | — | — | ✓ | — | — |
...
| Korean spoken | — | — | 4 | — | — | — | — |
| Mandarin spoken | — | — | 4 | — | — | — | — |
| Irish-Gaelic spoken | 2 | 2 | 2 | 2 | 5 | 3 | 2 |
| Latin spoken | 2 | 2 | 6 | 6 | 6 | 2 | 4 |
| Greek spoken | — | — | 1 | — | — | — | — |
| Salish-Sidhe spoken | 2 | 2 | 3 | 2 | 2 | 2 | 2 |
| Sign Language | — | 2 | 1 | 5 | 2 | — | 3 |

### English Specialties / Lingos
...
| Bioware | Effect |
|---|---|
| Muscle Toner 4 | +4 Quickness, −2TN Athletics/Escape Artist |
| Muscle Augmentation 4 | +4 Strength |
| Tailored Pheromones 2 | +4 CHA social tests within 20–30m (situational augmented stat) |
| Cerebral Booster 2 | +2 Intelligence |
| Synaptic Accelerator 2 | +2d6 Initiative (physical only — not decking/rigging) |
| Synthacardium 2 | +2 Athletics tests |
| Mnemonic Enhancer 3 | +3 Memory, +3 Language, +1 Knowledge, Knowledge defaults −1TN |
| Enhanced Articulation | +1 die Physical skill tests (physical only — not decking/rigging) |
| Cosmetic Surgery | +1 CHA permanently when physically present (close range) |
| Reaction Enhancers 6 | +6 Reaction (physical only — not decking/rigging) |

### Headware Architecture (3PR)
...
- **Cranial Cyberdeck:** MPCP 8 / Body 5 / Evasion 6 / Masking 8 / Sensors 5
  ...
  - Response Increase 2: +4 REA, +2d6 (decking only)
  - No native storage — MSCJ OMC chips
- **VCR 2:** +4 Reaction, +2d6 Initiative (rigging only), 250m range, heavy encryption
...
*Campaign Stats v1.4 — Malice Family Campaign*
