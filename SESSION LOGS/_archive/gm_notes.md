...
**Game:** Shadowrun 3rd Edition (SR3)
...
- RAVN-006: collection node, Building 1 NE interior — collection data recovered; destroyed S14
- RAVN-007: audio, 2 blocks south — destroyed S14
- RAVN-008: cellular intercept unit, shelter block — destroyed S14; R4 Browse Agent extracted intact
...
| Harlequin's Back | Proximity to volcano-affected site or Great Ghost Dance site | Fragmentary at first, builds with exposure |
...
## World Assets (Family — Unknown to Them)
...
## Session 14 — Merged Addendum

## New Canonical Facts — Session 14

### RAVN Network
- RAVN-005 through 008 destroyed S14
- RAVN-001 and 002 positions narrowed to city block level via signal triangulation from RAVN-006 collection data
- RAVN-008 confirmed cellular intercept unit — R4 Browse Agent hunting family by behavioral context, no direct commcodes
- Browse Agent extracted intact, targeting profile archived Singer headware
...
- CN-1: approached Nährboden, fully repelled (open test tie, defender wins). Commcode tapped via Singer LTG intercept. Sleeping in parking structure near Nährboden end of session
...
## Active GM Decisions Required — Session 15

- **CN-4 + Hearth Spirit:** She hits the F4 Hearth Spirit perimeter at Sandy Systems. Grade 0 vs Grade 8 masked auras. Auto-escalation to Iron Sill fires when she reports. GM controls timing of encounter and report
- **Cold Notch pivot:** CN-1 wakes in car with nothing. CN-2 stalled on Sandy Systems. What do they target next?
- **Harmon tripwire:** Does Reyes move on Harmon? When does the pixel fire?
- **Tir registry:** Family can run the query. What does it reveal?
- **RAVN placer response:** Devices burned, silence on network. Response posture GM controlled
- **Drake call:** Earliest 3/18, GM controlled
- **Browse Agent markers:** What behavioral profile was the agent keyed to? GM controls specifics
...
*GM Notes Addendum v1.0 — Session 14*
*⚠️ GM EYES ONLY*
...
*Session 15 decision prompts from the S14 addendum are merged above; existing S14 active threads are retained below for continuity.*
